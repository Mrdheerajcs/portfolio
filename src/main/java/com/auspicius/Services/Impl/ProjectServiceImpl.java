...
public class ProjectServiceImpl implements ProjectService {
    ...
    @Override
    public ApiResponse<Project> updateProject(UUID id, Project project) {
    ...
    public ApiResponse<List<Project>> findAllProjects() {
        ...
        return ResponseUtils.createSuccessResponse(projects);
    }

    @Override
    public ApiResponse<Project> findProjectById(UUID id) {
